...
class ExternalCustomerServiceClientTest {
    ...
    @InjectMocks
    private ExternalCustomerServiceClient externalCustomerServiceClient;
    ...
    void getCustomerByUniqueCode_shouldReturnCustomerAndPublishEvent() {
        ...
        Mono<CustomerDTO> result = externalCustomerServiceClient.getCustomerByUniqueCode("encryptedCode")
    ...
    void getCustomerByUniqueCode_shouldReturnErrorWhenCustomerNotFound() {
        ...
        verify(eventPublisher, never()).publishEvent(any(CustomerEvent.class));
    }
}
